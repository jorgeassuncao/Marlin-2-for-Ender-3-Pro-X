...
//#define CODEPENDENT_XY_HOMING
  ...
  //#define BLTOUCH_FORCE_SW_MODE   // EDIT
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    //#define X_CURRENT       800  // ORIGINAL
    #define X_CURRENT       510
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V    // EDIT
   ...
   */
  #define MONITOR_DRIVER_STATUS   // EDIT
